📚 Estrutura do Curso
O curso está organizado em módulos, e cada repositório reúne os conteúdos relacionados a um determinado tema.

🟦 Módulo 01 — Análise de Dados com Python
Semanas 01 a 12

O primeiro módulo apresenta os fundamentos da análise de dados, programação com Python, manipulação e tratamento de dados, bancos de dados, modelagem e SQL.

🗂️ Repositórios do Módulo 01
...
└── Semanas 11–12
    └── Python + SQL
        └── 05-python_sql
🚀 Próximos Módulos
Os demais conteúdos do curso serão adicionados posteriormente.
